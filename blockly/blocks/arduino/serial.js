...
Blockly.Blocks['serial_setup'] = {
    init: function() {
        this.jsonInit(
            {
                "type": "serial_setup",
                "message0": Blockly.Msg.ARD_SERIAL_SETUP,
                "args0": [
                    {
                        "type": "field_dropdown",
                        "name": "SPEED",
                ...
                "tooltip": Blockly.Msg.ARD_SERIAL_SETUP_TIP,
...
Blockly.Blocks['serial_print'] = {
    init: function() {
        this.jsonInit(
            {
                "type": "serial_print",
                "message0": Blockly.Msg.ARD_SERIAL_PRINT,
                "args0": [
                    {
                        "type": "input_value",
                        "name": "CONTENT"
                ...
                "helpUrl": 'hhttp://www.arduino.cc/en/Serial/Print'
            }
        );
    }
};
...
Blockly.Blocks['serial_println'] = {
    init: function() {
        this.jsonInit(
            {
                "type": "serial_println",
                "message0": Blockly.Msg.ARD_SERIAL_PRINTLN,
                "args0": [
                    {
                        "type": "input_value",
                        "name": "CONTENT"
...
Blockly.Blocks['serial_write'] = {
    init: function() {
        this.jsonInit(
            {
                "type": "serial_write",
                "message0": Blockly.Msg.ARD_SERIAL_WRITE,
                "args0": [
                    {
                        "type": "input_value",
                        "name": "CONTENT"
