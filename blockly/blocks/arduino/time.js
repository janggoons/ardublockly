...
Blockly.Blocks['time_delay'] = {
    init: function() {
        this.jsonInit(
            {
                "type": "time_delay",
                "message0": Blockly.Msg.ARD_TIME_DELAY,
                "args0": [
                    {
                        "type": "input_value",
                ...
                "tooltip": Blockly.Msg.ARD_TIME_DELAY_TIP,
        ...
        this.jsonInit(
            {
                ...
                "message0": Blockly.Msg.ARD_TIME_DELAY_MICROS,
                "args0": [
                    {
                        "type": "input_value",
                        "name": "DELAY_TIME_MICRO",
                        "check": Blockly.Types.NUMBER.output
                    }
                ],
                "previousStatement": null,
                ...
                "inputsInline": true,
                "colour": Blockly.Blocks.time.HUE,
                "tooltip": Blockly.Msg.ARD_TIME_DELAY_MICRO_TIP,
